...
def ablation_settings():
    ...
    switch_breakup_widget = widgets.Checkbox(value=False, description='Collisional breakup (Straub 2010)', style=style, layout={'width': 'max-content'})

    display('Ablation Lab - Physics toggles:', kelvin_widget, solute_widget, E_const_widget, vt_simple_widget, turb_kernel_widget, epsilon_widget, adaptive_dt_widget, switch_breakup_widget)
    return kelvin_widget, solute_widget, E_const_widget, vt_simple_widget, turb_kernel_widget, epsilon_widget, adaptive_dt_widget, switch_breakup_widget