...
Drop-in replacement for droplab.condensation.drop_condensation that replicates the
...
The object-based reference in droplab/condensation.py is kept intact and remains
