...
DEMOS = [
    ...
    dict(key="habit", title="✦ Ice-habit gallery", page="2D",
         ...
         pitch="Crystal SHAPES predicted by temperature — plates and columns coexist."),
    dict(key="warmrain", title="🌧️ Warm-rain shower", page="2D",
         scenario="idealized",
         toggles=dict(ice=False, collisions=True),
         pitch="A warm bubble rains out — collision–coalescence broadens the spectrum into drizzle."),
