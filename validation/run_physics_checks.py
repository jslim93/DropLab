...
from droplab.parameters import rho_liq, p0, r_a, cp, rv as RV
from droplab.aero_init import aero_init
from droplab.parcel import ascend_parcel, parcel_rho, create_env_profiles
from droplab.condensation import esatw
from droplab.condensation_fast import drop_condensation_fast as cond
from droplab.collision import collection
from droplab.mixing import ParameterizedMixing, redistribute_droplets, LEMMixing
...
from droplab.parameters import z_env as ZENV
...
og,_ = run(seed=0, aerosol="maritime", n_ptcl=2000, nt=1500, collisions=True, switch_TICE=False, eps=0.0, collect=(1500,))
ot,_ = run(seed=0, aerosol="maritime", n_ptcl=2000, nt=1500, collisions=True, switch_TICE=True, eps=0.04, collect=(1500,))
