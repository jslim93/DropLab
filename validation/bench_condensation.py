...
from droplab.condensation import drop_condensation
from droplab.condensation_fast import drop_condensation_fast
...
def main():
    ...
    block = (
        ...
        "Implementation: `droplab/condensation_fast.py` extracts particle state\n"
        ...
        "object-based reference in `droplab/condensation.py` is unchanged and\n"
