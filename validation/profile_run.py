"""Self-contained profiling driver for droplab condensation hot path.
...
Call path mirrors droplab/timestep_routine.py:
...
from droplab.parcel import parcel_rho
...
from droplab.parameters import r_a, rv
e_s = esatw(T_PARCEL)
