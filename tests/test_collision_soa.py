...
object collision physics from droplab/collision.py.
...
from droplab.parameters import rho_liq, r_a, p0, cp, rv, rho_aero, z_env
from droplab.collision_soa import collide_soa, collide_soa_enumerate
...
def _run_soa_ascent(seed, n_ptcl, nt, dt=1.0, T0=293.2, P0=1013e2, RH=0.92, w=1.0,
    ...
    from droplab.condensation_fast import drop_condensation_fast as drop_condensation
...
def test_statistical_equivalence_to_object_path():
    ...
    for the validated droplab-vs-Fortran comparison — within a Monte-Carlo
    tolerance (25%).
    """
